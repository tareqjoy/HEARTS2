...
public class CardDeck extends LinearLayout {
    ...
    public CardDeck(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
        init();
    }

    public CardDeck(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
